  ...
  const farmers = [
    {
      ...
      image: "https://images.unsplash.com/photo-1520052203542-d3095f1b6cf0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2069&q=80",
        ...
        <div className="page-container">
          <section className="mb-16">
            <div className="max-w-3xl mx-auto text-center mb-12">
              <h2 className="section-title">The Heart of Our Market</h2>
          ...
          <section className="mb-16 bg-market-brown-light/20 p-8 rounded-lg">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="subsection-title">Become a Market Fresh Farmer</h2>
                ...
                <button className="btn-primary">Apply to Become a Vendor</button>
              </div>
          ...
          <section className="mb-16">
            <h2 className="section-title text-center mb-12">Farm Tours & Events</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <button className="btn-primary w-full">See Schedule</button>
                </div>
              </div>
